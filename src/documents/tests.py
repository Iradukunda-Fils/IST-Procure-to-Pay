...
class DocumentAPITest(APITestCase):
    ...
    def test_document_metadata_endpoint(self):
        ...
        response = self.client.get(f'/api/documents/documents/{document.id}/metadata/')
    ...
    def test_document_processing_status_endpoint(self):
        ...
        response = self.client.get('/api/documents/documents/processing-status/')
    ...
    def test_document_update_permissions(self):
        ...
        self.authenticate_user(self.staff_user)
        response = self.client.patch(f'/api/documents/documents/{document.id}/', {
            'title': 'Updated Title'
        })
    ...
    def test_document_delete_permissions(self):
        ...
        self.authenticate_user(self.staff_user)
        response = self.client.delete(f'/api/documents/documents/{document.id}/')
