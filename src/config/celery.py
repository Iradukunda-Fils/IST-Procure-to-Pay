...
app.conf.update(
    ...
    task_routes={
        'documents.tasks.extract_document_metadata': {'queue': 'documents'},
        'documents.tasks.process_document_ocr': {'queue': 'documents'},
        'documents.tasks.extract_with_llm': {'queue': 'documents'},
        'purchases.tasks.generate_purchase_order': {'queue': 'purchases'},
        'purchases.tasks.generate_po_pdf': {'queue': 'purchases'},
