...
class PurchaseOrder(models.Model):
    ...
    total = models.DecimalField(
        ...
        decimal_places=2,
        validators=[MinValueValidator(Decimal('0.01'))],
        help_text='Total purchase order amount'
    )
    ...
    data = models.JSONField(
        default=dict,
        blank=True,
        help_text='Structured PO data including items, terms, and metadata'
    )
    ...
    pdf_document = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='purchase_orders_pdf',
        help_text='Generated PDF document for this PO'
    )
    ...
    sent_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text='Timestamp when PO was sent to vendor'
    )
